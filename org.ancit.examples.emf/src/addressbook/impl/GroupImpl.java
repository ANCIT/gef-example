 ...
 *   <li>{@link addressbook.impl.GroupImpl#getPosition <em>Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GroupImpl extends MinimalEObjectImpl.Container implements Group {
	...
	public NotificationChain basicSetPosition(Position newPosition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AddressbookPackage.GROUP__POSITION, oldPosition, newPosition);
	...
	public void setPosition(Position newPosition) {
		if (newPosition != position) {
			...
			if (position != null)
				msgs = ((InternalEObject)position).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AddressbookPackage.GROUP__POSITION, null, msgs);
			if (newPosition != null)
				msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AddressbookPackage.GROUP__POSITION, null, msgs);
			msgs = basicSetPosition(newPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.GROUP__POSITION, newPosition, newPosition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AddressbookPackage.GROUP__POSITION:
